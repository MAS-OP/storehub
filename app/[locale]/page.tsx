...
import { PARTICLE_THEMES } from "@/lib/particle-themes";
...
// ── Animated counter ──────────────────────────────────────
function Counter({ to, suffix = "" }: { to: number; suffix?: string | null }) {
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden" dir={isAr ? "rtl" : "ltr"}>
      <ParticleBackground theme={PARTICLE_THEMES[activeSection]} />
      <div className="relative z-10">
        ...
        <nav className="fixed top-0 inset-x-0 z-50 glass border-b border-border">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-foreground">StoreHub</span>
            </div>

            {/* Desktop nav links */}
            <div className="hidden md:flex items-center gap-8">
              {["features", "pricing"].map((key) => (
                <a key={key} href={`#${key}`} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  {t(`nav.${key}`)}
                </a>
              ))}
              <Link
          ...
          {mobileMenuOpen && (
            <div className="md:hidden glass border-t border-border px-4 py-4 space-y-3">
              ...
              <Link href={isAr ? "/en" : "/ar"} className="block text-center text-sm text-muted-foreground">
        ...
        <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
          <div className="relative z-10 max-w-5xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 glass-brand px-4 py-2 rounded-full text-sm text-accent font-medium mb-8"
            >
            ...
            >
              ...
              <a
                href="#how-it-works"
                className="flex items-center gap-3 px-8 py-4 rounded-2xl glass text-foreground font-semibold text-lg hover:bg-accent/5 transition-all"
              >
                {t("hero.ctaSecondary")}
              </a>
            </motion.div>
            ...
            <div className="glass rounded-3xl p-2 glow-brand">
              ...
              <div className="glass rounded-2xl p-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div className="flex-1 mx-4 glass rounded-lg px-3 py-1.5 text-xs text-muted-foreground text-center">
                    demo.storehub.sa
                  </div>
                </div>
                {/* Store mock content */}
                  ...
                  <div className="gradient-brand px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-white/70">demo.storehub.sa</div>
                      </div>
                    </div>
                    ...
                    {[
                      ...
                      <div key={p.name} className="glass rounded-xl overflow-hidden">
                        ...
                        <div className="p-2">
                          ...
                          <div className="text-xs text-accent font-bold">{p.price} ر.س</div>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <section id="how-it-works" className="py-24 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              {/* Connector line */}
              <div className="hidden md:block absolute top-1/3 inset-x-0 h-px bg-gradient-to-r from-transparent via-accent/30 to-transparent" />
              ...
              {featureKeys.map((key, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="glass rounded-3xl p-8 hover:bg-accent/5 transition-all group"
                  >
        ...
        {/* ── AI SPOTLIGHT ─────────────────────────────── */}
        <section id="ai-spotlight" className="py-24 px-4">
          <div className="max-w-5xl mx-auto">
            <motion.div
              initial="hidden" whileInView="visible" viewport={{ once: true }}
              variants={fadeUp}
            ...
            >
              <div className="glass rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
                <div className="flex-1 text-center md:text-start">
                  <div className="inline-flex items-center gap-2 bg-accent/10 border border-accent/25 rounded-full px-4 py-2 text-sm text-accent font-medium mb-6">
                ...
                <div className="w-full md:w-72 glass rounded-2xl p-4 space-y-3">
                  <div className="flex items-center gap-2 pb-3 border-b border-border">
                    ...
                    <span className="ms-auto text-xs bg-emerald-500/20 text-emerald-600 px-2 py-0.5 rounded-full">
                      {isAr ? "متاح" : "Online"}
                    </span>
                  </div>
                  {[
        ...
        <section id="pricing" className="py-24 px-4">
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="relative glass rounded-3xl p-8 md:p-12 border border-accent/30">
                <div className="text-center mb-8">
                  <div className="text-sm text-muted-foreground mb-2">{t("pricing.oneTime")}</div>
                  <div className="flex items-baseline justify-center gap-2 mb-2">
                    <span className="text-7xl font-black gradient-text-gold">٩٩٩</span>
                    <span className="text-2xl text-muted-foreground">{t("pricing.currency")}</span>
                  </div>
                  <div className="line-through text-muted-foreground text-lg">٢٬٩٩٩ {t("pricing.currency")}</div>
                  <div className="mt-3 inline-flex items-center gap-1.5 bg-emerald-500/15 text-emerald-600 text-sm px-3 py-1.5 rounded-full">
                    <CheckCircle className="w-4 h-4" />
                    {t("pricing.note")}
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {testimonials.map((t, i) => (
                ...
                >
                  ...
                  <p className="text-foreground/80 leading-relaxed mb-6 text-sm">&ldquo;{t.text}&rdquo;</p>
                  <div className="flex items-center gap-3">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <Link
                  href={`/${locale}/create`}
                  className="group inline-flex items-center gap-3 px-10 py-5 bg-white rounded-2xl text-accent font-black text-xl hover:scale-105 transition-transform shadow-2xl"
                >
                  {t("cta.button")}
                  <Arrow className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
                </Link>
          ...
          <div className="max-w-6xl mx-auto">
                ...
                <div key={section}>
                  ...
                  <ul className="space-y-2">
                    {section === "product" && ["features", "pricing", "demo"].map((link) => (
                      <li key={link}>
                        <a href={`#${link}`} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                          {t(`footer.links.${link}`)}
                        </a>
                      </li>
                    ))}
            ...
            <div className="border-t border-border pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                <Link href={isAr ? "/en" : "/ar"} className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  {isAr ? "English" : "العربية"}
                </Link>
              </div>
            </div>
